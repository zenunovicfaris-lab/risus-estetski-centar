        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_400px] gap-0 md:gap-16 items-start">
              ...
              return (
                ...
                >
                  <div className="border-t border-border py-7 md:py-8 flex items-start gap-6 cursor-default">
                    <span className={[
                      "font-sans text-[11px] tracking-[0.12em] mt-1.5 flex-shrink-0 transition-colors duration-150",
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className={[
                        "font-serif font-400 leading-tight transition-colors duration-150",
          ...
          <div className="hidden md:block sticky top-[110px]">
            <div className="relative overflow-hidden" style={{ height: "520px" }}>
              ...
              {/* All images preloaded, CSS opacity switch — no mount/unmount lag */}
